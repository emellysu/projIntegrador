...
<html lang="en">
  ...
  <body
      ...
      <div class="container">
          <a class="navbar-brand" href="Inicial.php">Pagina Inicial</a>
...
<h5 class="font_1">5) Tem algum curso na área de informática(basica, avançada)?</h5>
...
<input type="submit" name="Concluir" id = "enviar" value="Enviar" />
</form>
</body>
